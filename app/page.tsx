...
// Importamos el tipo GraphModel de TensorFlow.js para TypeScript
import { GraphModel } from '@tensorflow/tfjs'; 

// Definimos el tipo de estado para el modelo: GraphModel o null
type ModeloTipo = GraphModel | null;

export default function Home() {
    // Aplicamos el tipo ModeloTipo al estado
    const [modelo, setModelo] = useState<ModeloTipo>(null); 
    ...
    const convertir = async () => {
        // Verificamos si el modelo está cargado y si hay un valor de entrada
        if (modelo && celsius !== '') {
            try {
